...
func TestMigrate_LogConfigTables(t *testing.T) {
	...
	require.NoError(t, migrations.MigrateUp(orm.DB, "0024_create_log_config_table"))
	...
	require.NoError(t, migrations.MigrateDownFrom(orm.DB, "0024_create_log_config_table"))
